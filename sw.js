const CACHE='solar-atlas-v5';
const SHELL=['./','./index.html','./style.css?v=5','./app.js?v=5','./orbits.js','./timeline.js','./assets/three.module.min.js','./assets/OrbitControls.js','./assets/2k_saturn_ring_alpha.png','./manifest.webmanifest','./icon-192.png','./icon-512.png'];
